...
#creating my info and friends info tuples
my_tup = ('Karan', 'Shrestha', 23)

fren_tup1 = ('Bishal', 'Gurung', 21)

fren_tup2 = ('Shiva', 'Dangol', 40)

#creating list people
people = []
...
#normal sorted according to first value i.e. firstname
print(sorted(people))
